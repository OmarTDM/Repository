...
-- Creates the database and select it
CREATE DATABASE IF NOT EXISTS Volkstuinen;
USE Volkstuinen;

-- Creates complexes table
...
-- Creates all known complexes Into The complexes Table
...
-- Creates users table with foreign key reference to complexes(id)
...
-- Creates messages table with foreign key reference to complexes(id)
...
-- Creates requests table with foreign key reference to complexes(id)
...
-- Creates parcel table with foreign key reference to complexes(id)
...
-- Creates parcel-requests table with foreign key reference to complexes(id) & users(id)
